...
def run(context):
	...
	###### Linha vertical do ponto inicial do intervalo (0,0,0 até f(0)) ou "inicio da integral"
		...
		line2 = lines.addByTwoPoints(adsk.core.Point3D.create(0, 0, 0), adsk.core.Point3D.create(0, 0,0))

	###### Gráfico 1 ### f(x) = Se(0 ≤ x ≤ 2, 0.25x^2) ###### 
	...
	###### Fim de todos os gráficos
		line2 = lines.addByTwoPoints(adsk.core.Point3D.create(0, t, 0), adsk.core.Point3D.create(2*t**(1/2), t,0))
